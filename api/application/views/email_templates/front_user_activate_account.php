...
<table border="0" cellspacing="0" cellpadding="0" align="center" style="background:#fff; width:600px;">
  <tbody>
    ...
    <tr>
      <td style="padding:20px; background:#f5f5f5;"><p style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:20px; margin:0 0 10px 0px;  padding:0;  font-size:22px; color:#fb765b; font-weight:bold;">Hello <?php echo $fname; ?></p>
        ...
        <p style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:22px; margin:0 0 15px 0px; padding:0; font-size:14px; color:#333; font-weight:normal;color: #FF0000;">Please verify your email address to enable FindUs to back up any FindUs QR Codes, including Loyalty Counts and Special Alerts.</p>
        <p style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:22px; margin:0 0 15px 0px; padding:0; font-size:14px; color:#333; font-weight:normal;color: #FF0000;">Thank you for joining us and look out for the FindUs Codes you will find them everywhere. Start collecting today!</p>
        
        <a href="<?php echo base_url('/activate-user') . '/' . base64_encode($email); ?>" style="border-radius:5px; padding:8px 16px; margin:10px 0 15px 0px; display:inline-block; background:#ff5722; color:#fff; font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; text-decoration:none; font-weight:bold; cursor: pointer;"> Verify Your Email </a>
