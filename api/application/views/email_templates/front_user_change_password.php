...
<table border="0" cellspacing="0" cellpadding="0" align="center" style="background:#fff; width:600px;">
  <tbody>
    ...
    <tr>
      <td style="padding:20px; background:#f5f5f5;"><p style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:20px; margin:0 0 10px 0px;  padding:0;  font-size:22px; color:#fb765b; font-weight:bold;">Hello <?php echo $email; ?></p>
        <p style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:20px; margin:0 0 15px 0px;  padding:0;  font-size:18px; color:#444; font-weight:bold;color: #FF0000;">Please click on given button below to set new password,</p>

      
        
        <a href="<?php echo $url; ?>" style="border-radius:5px; padding:8px 16px; margin:10px 0 15px 0px; display:inline-block; background:#ff5722; color:#fff; font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; text-decoration:none; font-weight:bold; cursor: pointer;"> Click Here </a>
